...
1. SmaTelcom is **private software**. It is **not** MIT and is **not** a public Apache-2.0 open-source grant.
...
7. Third-party dependencies retain their own licenses (see `package-lock.json` / Cargo crates); this file governs **SmaTelcom original code and branding only**.

---

## 2. How to obtain Authorization

1. Email **<rabbittrix@hotmail.com>** with subject: `SmaTelcom License Authorization Request`
...
| **BIC / SWIFT** | `REVOPTP2` |
| **Currency** | EUR |
| **Reference** | `SmaTelcom License — <Your Name/Company>` |

### SEPA payment QR code

Scan with your banking app (EPC QR / SEPA Credit Transfer):

![SmaTelcom license payment QR](./payment_transfer_qr.png)
...
- Training published models on proprietary SmaTelcom sources for commercial products without Authorization  
